...
if language == "cn":
    from ..prompts.document_prompts_cn import GENERATE_DOCUMENT_TOPICS_PROMPT, NUM_TOPICS
elif language == "en":
    from ..prompts.document_prompts_en import GENERATE_DOCUMENT_TOPICS_PROMPT, NUM_TOPICS
else:
    raise ValueError
