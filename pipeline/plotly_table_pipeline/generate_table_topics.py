...
if language == "cn":
    from ..prompts.table_prompts_cn import GENERATE_TABLE_TOPICS_PROMPT, NUM_TOPICS
elif language == "en":
    from ..prompts.table_prompts_en import GENERATE_TABLE_TOPICS_PROMPT, NUM_TOPICS
else:
    raise ValueError
